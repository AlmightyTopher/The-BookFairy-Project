...
To get an API token, you need to go to your account settings page and click on the <a href="https://hardcover.app/account/api" target="_blank" rel="noreferrer noopener">Hardcover API</a> link; the token will be available at the top of the page. the token will be available at the top of the page.
...
![Example of the authorization header](/images/api/getting-started/graphql-authorization-header.png)
...
![Showing the location of the Authorization Token field in the GraphQL Explorer](/images/api/getting-started/graphql-explorer-token-field.png)
...
<figcaption><span class="title">Example Request</span></figcaption>
</figure>
...
<div id="tab-panel-1" aria-labelledby="tab-1" role="tabpanel" tabindex="0" hidden="">
...
- <span class="sl-badge danger small astro-avdet4wd">Don't share your token! Someone could delete your account with it.</span>
...
- <span class="sl-badge note small astro-avdet4wd">Recommendation</span> When authoring scripts that use the API, it is recommended to include a user-agent header with a description of the script.
